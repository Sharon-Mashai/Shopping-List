...
import { ListViewIcon, ShoppingBasket01Icon, ShoppingCart01Icon, Tick01Icon, Add01Icon, FileEmpty02Icon, Delete02Icon, AlertCircleIcon,} from "@hugeicons/core-free-icons";
...
function Home() {
  ...
  const {shoppingLists,loading, error,
  } = useSelector(
    (state: RootState) =>
      state.shoppingLists,
  );
  ...
  const [listStats, setListStats] =
    useState<Record<string, ListStats>>({});
