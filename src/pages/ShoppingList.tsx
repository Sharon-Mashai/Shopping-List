...
const categoryRules: CategoryRule[] = [
  {
    keywords: [ "bread","roll","rolls", "bun", "buns","cake","cakes", "muffin", "muffins", "croissant", "pastry", "pastries", "bagel", "bagels",],
    category: "Bakery",
  ...
  {
    keywords: [ "apple","apples", "banana", "bananas", "orange", "oranges","grape", "grapes", "strawberry", "strawberries", "mango", "mangoes", "pear", "pears", "watermelon","pineapple",],
    category: "Fruit",
    acceptedCategories: ["fruit","fruits","produce","groceries","grocery","food",],
  },

  {
    keywords: [ "carrot", "carrots", "potato", "potatoes","tomato",  "tomatoes", "onion", "onions", "cabbage", "spinach", "lettuce","broccoli","pepper","peppers",],
    category: "Vegetables",
    acceptedCategories: [ "vegetable","vegetables","produce","groceries","grocery", "food",],
  },

  {
    keywords: [ "beef","chicken", "pork","steak", "sausage", "sausages", "mince", "meat",],
    category: "Meat",
  ...
  {
    keywords: [ "rice","pasta","flour", "sugar","salt", "cereal","oats","beans", "lentils",],
    category: "Groceries",
    acceptedCategories: ["groceries", "grocery", "food", "pantry"],
  },

  {
    keywords: ["juice", "water", "soda",  "cooldrink", "cool drink",  "coffee", "tea", "drink",],
    category: "Beverages",
    acceptedCategories: [ "beverage","beverages", "drinks", "drink", "groceries", "grocery", "food",  ],
  },

  {
    keywords: [ "chips", "crisps", "chocolate", "candy", "sweets", "biscuits", "cookies", "snack", "snacks", ],
    category: "Snacks",
    acceptedCategories: ["snack", "snacks", "groceries", "grocery", "food"],
  },

  {
    keywords: ["soap", "toothpaste", "toothbrush", "shampoo", "conditioner", "deodorant", "lotion","body wash",],
    category: "Personal Care",
    acceptedCategories: [ "personal care", "hygiene", "toiletries", "health", "beauty",],
  },
